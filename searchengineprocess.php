	...
	try {
		...
		echo '<table class="sortable" id="rounded-corner">';
			   ...
			   <tr>
				 ...
				 <th scope="col">Region</td>
				 <th scope="col">Type</td>
				 <th scope="col">Main purpose</td>
				 <th scope="col">Website</td>
				 <th scope="col">Key interests</td>
				 <th scope="col">Keywords</td>
				 <th scope="col">Send email</td>
			   </tr>
			   </thead><tbody>';
		...
		while($row = $stmt->fetch(PDO::FETCH_OBJ)) {	
				...
				<tr>
				 ...
				 <td><label>																
							<input type="button" id="mailsendbutton" value="Click" />	
							<div class="blackout">
							</div>
							<div class="msgbox">									
							<br />
